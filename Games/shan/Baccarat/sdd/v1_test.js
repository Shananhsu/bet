...
sddStart.addEventListener("click", function () {
    // //產生第一張牌
    const abc_1 = poker[Math.floor(Math.random() * poker.length)];
    bankPoker.push(abc_1);
    // console.log('池底的牌：', abc_1[2]);
    // console.log([poker]);

    // //產生第二張牌
    const abc_2 = poker[Math.floor(Math.random() * poker.length)];
    sddPlayer_1.push(abc_2);
    console.log('第二張：', abc_2[2]);
    // console.log([poker]);
...
sddCallcard.addEventListener("click", function () {
    //產生第三張牌
    const abc_3 = poker[Math.floor(Math.random() * poker.length)];
    sddPlayer_2.push(abc_3)
    console.log('你的牌：', abc_3[2]);
    // console.log([poker]);
    if (
