...
//黃球擺放位置
    this.blueBalls = [
    new Ball(new Vector2(1022,413),Color.blue),//1
    new Ball(new Vector2(1056,393),Color.blue),//2
    new Ball(new Vector2(1090,452),Color.blue),//6
    new Ball(new Vector2(1126,354),Color.blue),//7
    new Ball(new Vector2(1126,433),Color.blue),//9
    new Ball(new Vector2(1162,413),Color.blue),//13
    new Ball(new Vector2(1162,491),Color.blue)//15
    ];
//黑白球擺放位置
    this.whiteBall = new Ball(new Vector2(413,413),Color.white);
    this.goldBall = new Ball(new Vector2(1090,413),Color.gold);
...
axios.get("http://localhost:3001/biliard/fetch")
